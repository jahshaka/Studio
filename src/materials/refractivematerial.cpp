...
RefractiveEffect::RefractiveEffect()
{
    ...
    //shader->setVertexShaderCode(shader->loadSource(QUrl(QStringLiteral("qrc:/assets/shaders/refractive_material.vert"))));
    //shader->setFragmentShaderCode(shader->loadSource(QUrl(QStringLiteral("qrc:/assets/shaders/refractive_material.frag"))));
