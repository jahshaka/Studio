...
QVector<VerbInfo> WorldApi::verbs() const
{
    return {
        ...
        { "clearOverrides", "world.clearOverrides() -> object",
          ...
          Needs::Document },
        { "postFx", "world.postFx({exposureEv, exposureMin, exposureMax, exposureMeterLow, exposureMeterHigh, bloomThreshold, bloomKnee, ssaoPower, ssaoRadius, distortionStrength}) -> object + {exposureMeasured}",
