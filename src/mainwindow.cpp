...
{
    // Hierarchy Dock
    sceneHierarchyDock = new QDockWidget(tr("Hierarchy"), viewPort);
    ...
    sceneNodePropertiesDock = new QDockWidget(tr("Properties"), viewPort);
    ...
    // Presets Dock
    presetsDock = new QDockWidget(tr("Presets"), viewPort);
    ...
    // Asset Dock
    assetDock = new QDockWidget(tr("Asset Browser"), viewPort);
    ...
    // Animation Dock
    animationDock = new QDockWidget(tr("Timeline"), viewPort);
...
void MainWindow::setupToolBar()
{
 ...
 //actionRotate->setIcon(QIcon(":/icons/rotate-to-right.svg"));
	...
	actionRotate->setFont(awesome->font(16));     toolBar->addAction(actionRotate);
