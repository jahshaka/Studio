...
Database::Database()
{
    ...
    version072SchemaUpdate = "ALTER TABLE assets ADD view_filter INTEGER;";
}
...
void Database::updateSchema()
{
    ...
    QSqlQuery query;
    query.prepare(version072SchemaUpdate);
    executeAndCheckQuery(query, "072SchemaUpdate");
}
